        ...
        <ul>
            ...
            <li>
                ...
                <li><a href="../loans/requesting_loan.php">Request Loans</a></li>
                    <li><a href="../loan/requested_loan.php">Requested Loans</a></li>
                    <li><a href="../loan/pending_loan.php">Pending Loans</a></li>
                    <li><a href="../loan/approved_loan.php">Approved Loans</a></li>
                    <li><a href="../loan/rejected_loan.php">rejected Loans</a></li>
            ...
            <li>
                <a href="#">Penalties</a>
                <ul class="submenu">
                    <li><a href="pay_penality.php">Pay Penalty</a></li>
                    <li><a href="penallty_status.php">Penalty Status</a></li>
                    <li><a href="penalty_managment.php">Penalty Management</a></li>
                </ul>
            </li>
            ...
            <li>
                <a href="#">Statistics</a>
                <ul class="submenu">
                    <li><a href="../saving/interest_calculation.php">Financial Statistics</a></li>
