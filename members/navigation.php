        ...
        <ul>
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="select-all.php">Display All Users</a></li>
                    <li><a href="select-all.php">User Operations</a></li>
                </ul>
            </li>
            <!-- Loans Subcategories -->
            <li>
                ...
                <li><a href="../loans/requesting_loan.php">Request Loans</a></li>
                    ...
                    <li><a href="../loans/loans/pay_loan.php">pay for Loans</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="user_activity_statistics.php">User Activity Statistics</a></li>
                    <li><a href="perfomance_metrics.php">Performance Metrics</a></li>
