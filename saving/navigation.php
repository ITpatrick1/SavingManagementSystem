        ...
        <ul>
            ...
            <li>
                ...
                <li><a href="../loans/requesting_loan.php">Request Loans</a></li>
                    <li><a href="../loans/requested_loan.php">Requested Loans</a></li>
                    <li><a href="../loans/pending_loan.php">Pending Loans</a></li>
                    <li><a href="../loans/approved_loan.php">Approved Loans</a></li>
                    <li><a href="../loans/rejected_loan.php">rejected Loans</a></li>
            ...
            <li>
                <a href="#">Savings</a>
                <ul class="submenu">
                    <li><a href="saving.php">Deposit Savings</a></li>
                    <li><a href="withdrawal_savings.php">Withdrawal Savings</a></li>
                    <li><a href="transaction_statistics.php">Savings Transactions</a></li>
                    <li><a href="check_balance.php">Check you balance</a></li>
                    <li><a href="interest_calculation.php">Interest Calculation</a></li>
                </ul>
            </li>
            <!-- Interest Rate -->
            <li><a href="interest_calculation.php">Interest Rate</a></li>
            <!-- Statistics Subcategories -->
            <li>
                <a href="#">Statistics</a>
                <ul class="submenu">
                    <li><a href="financial_statistics.php">Financial Statistics</a></li>
